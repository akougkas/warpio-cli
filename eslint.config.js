...
export default tseslint.config(
  ...
  },
  {
    ...
    ignores: [
      ...
      'packages/cli/src/ui/components/EnhancedErrorMessage.tsx',
      'packages/cli/src/ui/components/ModelStatus.tsx',
      'packages/cli/src/ui/components/ProviderStatus.tsx',
      'packages/core/src/config/providerConfig.ts',
      'packages/core/src/reasoning/**',
      'packages/core/src/services/modelFallback.ts',
      'packages/core/src/services/modelManager.ts',
      'test/e2e/local-models.test.ts',
      'test/e2e/model-switching.test.ts',
      'test/e2e/personas.test.ts',
      'test/e2e/model-ui.test.ts',
