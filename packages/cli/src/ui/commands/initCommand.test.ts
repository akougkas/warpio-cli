...
describe('initCommand', () => {
  ...
  it('should inform the user if WARPIO.md already exists', async () => {
  ...
  it('should create WARPIO.md and submit a prompt if it does not exist', async () => {
    ...
    expect(fs.writeFileSync).toHaveBeenCalledWith(warpioMdPath, '', 'utf8');
    ...
    expect(result.content).toContain(
      'You are Warpio, developed by the IOWarp team',
    );
  });
