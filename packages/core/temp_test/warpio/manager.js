...
export class WarpioPersonaManager {
    ...
    async activatePersona(personaName) {
        ...
        if (persona.providerPreferences) {
            ...
            console.log(`🔧 Applied provider preferences for ${personaName}: ${persona.providerPreferences.preferred}:${persona.providerPreferences.model || 'default'}`);
        }
    ...
    async deactivatePersona() {
        ...
        console.log('🔧 Cleared provider preferences');
